...
//----------------------------------------------------------------------------------------------------------------------------------
      ...
      <form action="contact.php" id="contact_form" method="post">
         ...
         <fieldset id="questions">
            ...
            <br>
            <textarea id="other_reason_for_contact" name="other_reason_for_contact" rows="10" cols="150" placeholder="Other Reason for Contact">$other_reason_for_contact</textarea>
         </fieldset>
